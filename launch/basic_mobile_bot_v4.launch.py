...
def generate_launch_description():
  ...
  robot_localization_file_path = os.path.join(pkg_share, 'config/ekf.yaml')                 #### EKF

  navsat_file_path = os.path.join(pkg_share, 'config/navsat_transform_config.yaml') ### NAVSAT
  ...
  start_robot_localization_cmd = Node(                                      ## EKF
  ...
  navsat_transform_node = Node( ## NAVSAT
    package    = 'robot_localization',
